...
<body onload="startTime()" style="background-color: #937761;">
    ...
    <h2>
       <table border="0" width="100%">
        ...
        <tr align="center">
                <td><font color="#ffffff" size="3px">รหัสวัตถุดิบ</td>
                <td><font color="#ffffff" size="3px">รายชื่อวัตถุดิบ</td>
                <td><font color="#ffffff" size="3px">ปริมาณคงเหลือ</td>
                <td><font color="#ffffff" size="3px">สั่งเพิ่ม</td>
        </tr>
        <?php
